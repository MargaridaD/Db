...
public class pessoaController {
    ...
    public ResponseEntity<SimpleResponse> addPessoas(@RequestBody Wrapper wrapper){
        ...
        if (wrapper.getPessoa().getName() == null || wrapper.getPessoa().getName().isBlank()){
        ...
        if (pessoa_service.addPessoa(wrapper.getPessoa(), wrapper.getEmpresa())){
